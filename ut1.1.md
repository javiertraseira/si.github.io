...
>   tratamiento automático de la información por medio de dispositivos
>   digitales, denominados ordenadores o computadoras.
...
La **evolución** del hardware desde el SXX a la actualidad ha sido tecnológicamente vertiginosa y se clasifica en <u>cuatro</u> generaciones:
...
- **4ª Generación** *(1975-hoy)* Llegan los primeros **Microprocesadores**.
Aparece el primer ordenador personal, las supercomputadoras actuales y los smartphones. Aparecen los SO en red, móviles y distribuidos.
...
-  Aparición del primer ordenador personal (PC) de IBM

-  Ejemplo: IBM PC, 1.500.000\$

-  Electrónica de consumo moderna
